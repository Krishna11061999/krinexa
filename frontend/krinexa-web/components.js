      ...
      <div class="container-fluid px-lg-5">
        ...
        <div class="collapse navbar-collapse" id="krNavbarContent">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0 gap-1">
            <li class="nav-item">
              <a class="nav-link-custom ${currentPath.includes('index') || currentPath.endsWith('/') ? 'active' : ''}" href="index.html">Marketplace</a>
            </li>
            <li class="nav-item">
              <a class="nav-link-custom ${currentPath.includes('registration') ? 'active' : ''}" href="02-registration.html">Talent Network</a>
            </li>
            <li class="nav-item">
              <a class="nav-link-custom ${currentPath.includes('project-interest') ? 'active' : ''}" href="04-project-interest.html">Requirements</a>
            </li>
            <li class="nav-item">
              <a class="nav-link-custom ${currentPath.includes('chat') ? 'active' : ''}" href="03-chat.html">Project Chat</a>
            </li>
            <li class="nav-item">
              <a class="nav-link-custom ${currentPath.includes('admin') ? 'active' : ''}" href="06-admin-index.html">Admin Console</a>
            </li>
          </ul>
